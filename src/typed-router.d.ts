...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/GameMultiPlayer': RouteRecordInfo<'/GameMultiPlayer', '/GameMultiPlayer', Record<never, never>, Record<never, never>>,
    ...
    '/SaltFieldAuto': RouteRecordInfo<'/SaltFieldAuto', '/SaltFieldAuto', Record<never, never>, Record<never, never>>,
    ...
    '/TokenImport/mobile': RouteRecordInfo<'/TokenImport/mobile', '/TokenImport/mobile', Record<never, never>, Record<never, never>>,
