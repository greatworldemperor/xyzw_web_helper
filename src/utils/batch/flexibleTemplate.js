...
export const flexibleTaskGroups = [
  {
    ...
    tasks: [
      ...
      dailyTask("daily.claimHangUp", "领取挂机奖励"),
      dailyTask("daily.addHangUpTime", "挂机加钟4次"),
      ...
      dailyTask("daily.blackMarket", "黑市购买1次"),
      dailyTask("daily.dream", "咸王梦境"),
      dailyTask("daily.deepSeaGenie", "深海灯神"),
  ...
  },
  {
    ...
    label: "日常批量",
    tasks: [
      batchTask("claimHangUpRewards", "领取挂机并加钟"),
      batchTask("batchAddHangUpTime", "一键加钟"),
      batchTask("resetBottles", "重置罐子"),
      batchTask("batchlingguanzi", "一键领取罐子"),
      batchTask("batchclubsign", "一键俱乐部签到"),
      batchTask("batchStudy", "一键答题"),
      batchTask("batcharenafight", "一键竞技场战斗3次"),
      batchTask("batchSmartSendCar", "智能发车"),
      batchTask("batchClaimCars", "一键收车"),
      batchTask("store_purchase", "一键黑市采购"),
      batchTask("collection_claimfreereward", "一键领取珍宝阁"),
      batchTask("batchGenieSweep", "一键灯神扫荡"),
    ],
  },
  {
    name: "dungeon",
    ...
    tasks: [
      ...
      batchTask("batchmengjing", "一键梦境"),
      batchTask("skinChallenge", "一键换皮闯关"),
      batchTask("batchClaimPeachTasks", "一键领取蟠桃园任务"),
      batchTask("batchBuyDreamItems", "一键购买梦境商品"),
      batchTask("batchFootballBet", "一键竞猜"),
    ],
  },
  {
    name: "treasury",
  ...
  },
  {
    ...
    tasks: [
      ...
      batchTask("batchOpenBoxByPoints", "按积分开箱", {
